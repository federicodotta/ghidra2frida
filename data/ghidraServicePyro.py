...
class BridaServicePyro:
    ...
    def attach_application(self,pid,frida_script,device,host):
    ...
    def spawn_application(self,application_id,frida_script,device,host):
